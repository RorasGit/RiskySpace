...
public class GLFleetMenu extends GLAbstractSideMenu {
	...
	public void initSprites() { 
		...
		shipIcons.put("COLONIZER_GREEN",new GLSprite("ship_icons", 	192,	0, 		64, 64));
		
		shipIcons.put("SCOUT_PINK", 	new GLSprite("ship_icons", 	0, 		64, 	64, 64));
		shipIcons.put("HUNTER_PINK", 	new GLSprite("ship_icons", 	64, 	64, 	64, 64));
		shipIcons.put("DESTROYER_PINK", new GLSprite("ship_icons", 	128, 	64, 	64, 64));
		shipIcons.put("COLONIZER_PINK",	new GLSprite("ship_icons", 	192, 	64, 	64, 64));
		...
		shipIcons.put("DESTROYER_BLUE", new GLSprite("ship_icons", 	128, 	128, 	64, 64));
		shipIcons.put("COLONIZER_BLUE", new GLSprite("ship_icons", 	192, 	128, 	64, 64));
		
		shipIcons.put("SCOUT_RED", 		new GLSprite("ship_icons", 	0, 		192, 	64, 64));
		shipIcons.put("HUNTER_RED", 	new GLSprite("ship_icons", 	64, 	192, 	64, 64));
		shipIcons.put("DESTROYER_RED",	new GLSprite("ship_icons", 	128, 	192,	64, 64));
		shipIcons.put("COLONIZER_RED",	new GLSprite("ship_icons", 	192, 	192, 	64, 64));
	}
