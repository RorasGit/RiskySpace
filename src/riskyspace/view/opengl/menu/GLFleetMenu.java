...
public class GLFleetMenu extends GLAbstractSideMenu {
	...
	private void setFleetPictures() {
		...
		fleetPictures.put(Player.YELLOW, new GLSprite("palpatine", 640, 480));
	}
	...
	public void initSprites() { 
		...
		shipIcons.put("SCOUT_YELLOW", 		new GLSprite("ship_icons", 	0, 		64, 	64, 64));
		shipIcons.put("HUNTER_YELLOW", 		new GLSprite("ship_icons", 	64, 	64, 	64, 64));
		shipIcons.put("COLONIZER_YELLOW", 	new GLSprite("ship_icons", 	128, 	64, 	64, 64));
		shipIcons.put("DESTROYER_YELLOW",	new GLSprite("ship_icons", 	192, 	64, 	64, 64));
