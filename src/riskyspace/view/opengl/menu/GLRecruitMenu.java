...
public class GLRecruitMenu extends GLAbstractSideMenu {
	...
	private void setButtons() {
		...
		buildScoutButton.setDisabledSprite(new GLSprite("ship_icons_grey_cost", 0, 64, 64, 64));
		...
		buildHunterButton.setDisabledSprite(new GLSprite("ship_icons_grey_cost", 64, 64, 64, 64));
		...
		buildDestroyerButton.setDisabledSprite(new GLSprite("ship_icons_grey_cost", 64, 0, 64, 64));
		...
		buildColonizerButton.setDisabledSprite(new GLSprite("ship_icons_grey_cost", 0, 0, 64, 64));
	...
	private void setImages(Player player) {
		...
		buildScoutButton.setTexture(	"ship_icons_cost",   0, y[i], 64, 64);
		buildHunterButton.setTexture(	"ship_icons_cost",  64, y[i], 64, 64);
		buildColonizerButton.setTexture("ship_icons_cost", 128, y[i], 64, 64);
		buildDestroyerButton.setTexture("ship_icons_cost", 192, y[i], 64, 64);
	}
